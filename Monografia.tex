...
\preambulo{ Monografia do trabalho de conclusão de curso apresentado ao Instituto Federal Minas Gerais - Campus Formiga, como requisito obrigatório para a obtenção do título de Bacharel em Ciência da Computação. }
% ---
...
\begin{fichacatalografica}
	...
	\hspace{0.5cm}
		...
		2. Otimização.
		I. Everthon Valadão.
		II. Instituto Federal de Minas Gerais Campus Formiga.
		III. Bacharelado em Ciência da Computação.
		IV. Otimização do Posicionamento de Pontos de Acesso Wireless	
	\end{minipage}}
	\end{center}
\end{fichacatalografica}
% ---
...
\begin{folhadeaprovacao}
  ...
  \begin{center}
   ...
   \imprimirlocal, 14 de novembro de 2017:

   \assinatura{\textbf{\imprimirorientador} \\ } 
   \assinatura{\textbf{Prof.º Diego Mello da Silva} \\  }
   \assinatura{\textbf{Prof.º Rafael Tayette de Nóbrega} \\}
   \assinatura{\textbf{Prof.º Walace de Almeida Rodrigues} \\ }
