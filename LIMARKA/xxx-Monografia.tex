...
\data{2017}
\local{FORMIGA - MG}
\orientador{Prof.~M. Everthon Valadão dos Santos}
\coorientador{}
\instituicao{%
...
parâmetros definidos para a alocação de vários \emph{access points}
foram adaptados dos parâmetros utilizados no \emph{Simulated Annealing}
com um \emph{access point}.
